...
const BATTLEMETRICS_API_RESERVIOR = process.env.BATTLEMETRICS_API_RESERVIOR || 500;
...
// Other constants
const DISCORD_INVITE = process.env.DISCORD_INVITE || 'https://discord.com/invite/Urm7MV8xgS';
